...
ws = wb['MarketIndex']  # Work Sheet
ws1 = wb['Sheet4']  # Work Sheet
Service = ws['A']  # Column
Symbol = ws['B']
GQL_Query = ws['C']
query =  GQL_Query
...
gpql_json_data1=[]
webservice_curr_val_value=[]
webservice_pre_val_value=[]
webservice_open_val_value=[]
webservice_Net_val_value=[]
webservice_per_cha_value=[]
...
for i,j,k in zip(GQL_Query_list,Service_list,Symbol_list):
    ...
    try:
        webservice_curr_val_value1 = driver.find_element(By.XPATH, "//*/tr[6]/td[2]").text
        webservice_pre_val_value1 = driver.find_element(By.XPATH, "//*/tr[19]/td[2]").text
        webservice_open_val_value1 = driver.find_element(By.XPATH, "//*/tr[18]/td[2]").text
        webservice_Net_val_value1 = driver.find_element(By.XPATH, "//*/tr[11]/td[2]").text
        webservice_per_cha_value1 = driver.find_element(By.XPATH, "//*/tr[31]/td[2]").text


    except:
        webservice_curr_val_value.append('None')
        webservice_pre_val_value.append('None')
        webservice_open_val_value.append('None')
        webservice_Net_val_value.append('None')
        webservice_per_cha_value.append('None')



        continue
    else:
        webservice_curr_val_value.append(webservice_curr_val_value1)
        webservice_pre_val_value.append(webservice_pre_val_value1)
        webservice_open_val_value.append(webservice_open_val_value1)
        webservice_Net_val_value.append(webservice_Net_val_value1)
        webservice_per_cha_value.append(webservice_per_cha_value1)
...
print(webservice_curr_val_value)
print(webservice_pre_val_value)
print(webservice_open_val_value)
print(webservice_Net_val_value)
print(webservice_per_cha_value)
