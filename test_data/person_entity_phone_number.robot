...
${Gql_person_entity_getIndividual}     query{person(priceRefreshOption:LIVE, valuationPriceBasis:BID, charlesStanleyId:"AAAD6789"){nodes{telephoneNumbers{phoneNumber} }}}
