...
${Gql_person_entity_getIndividual}     query{person(priceRefreshOption:LIVE, valuationPriceBasis:BID, charlesStanleyId:"AAAD6789"){nodes{ addresses{addressLine1 addressLine2 addressLine3 addressLine4 addressLine5 postCode} }}}
