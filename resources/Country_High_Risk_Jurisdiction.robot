*** Settings ***
Documentation       Country High Risk Jurisdiction Entity Keywords
...
Country High Risk Jurisdiction entity attributes validation
    ${row}=     Read number of rows  CountryHighRiskJurisdiction
    ${data}=    Read Excel Data of Cell   CountryHighRiskJurisdiction  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     CountryHighRiskJurisdiction  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     CountryHighRiskJurisdiction  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     CountryHighRiskJurisdiction  ${i}  4
