...
Instrument DividendPayments entity attributes validation
    ${row}=     Read number of rows  DividendPayments
    ${data}=    Read Excel Data of Cell   DividendPayments  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     DividendPayments  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     DividendPayments  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     DividendPayments  ${i}  4
