...
Instrument FundTop10Holdings entity attributes validation
    ${row}=     Read number of rows  FundTop10Holdings
    ${data}=    Read Excel Data of Cell   FundTop10Holdings  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     FundTop10Holdings  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     FundTop10Holdings  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     FundTop10Holdings  ${i}  4
