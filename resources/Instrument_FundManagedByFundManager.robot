...
Instrument FundManagedByFundManager entity attributes validation
    ${row}=     Read number of rows  FundManagedByFundManager
    ${data}=    Read Excel Data of Cell   FundManagedByFundManager  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     FundManagedByFundManager  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     FundManagedByFundManager  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     FundManagedByFundManager  ${i}  4
