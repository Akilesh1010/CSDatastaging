...
Instrument TradeCondition entity attributes validation
    ${row}=     Read number of rows  Tradecondition
    ${data}=    Read Excel Data of Cell   Tradecondition  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell      Tradecondition  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     Tradecondition  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     Tradecondition   ${i}  4
