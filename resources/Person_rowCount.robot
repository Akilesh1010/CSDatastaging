...
Person entity OLEDB row validation
    ${row}=     Read number of rows  Row_CountPerson
    ${data}=    Read Excel Data of Cell   Row_CountPerson   1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     Row_CountPerson    ${i}  2
...
Person entity stagingDB row validation
    ...
    ${data}=    Read Excel Data of Cell   Row_CountPerson   1  1
      ...
      ${SDB_Query}=    Read Excel Data of Cell      Row_CountPerson    ${i}  3
