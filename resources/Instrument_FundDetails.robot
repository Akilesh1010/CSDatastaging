...
Instrument FundDetails entity attributes validation
    ${row}=     Read number of rows  FundDetails
    ${data}=    Read Excel Data of Cell   FundDetails  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     FundDetails  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     FundDetails  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     FundDetails  ${i}  4
