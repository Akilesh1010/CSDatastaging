...
Instrument FundGeography entity attributes validation
    ${row}=     Read number of rows  FundGeography
    ${data}=    Read Excel Data of Cell   FundGeography  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     FundGeography  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     FundGeography  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     FundGeography  ${i}  4
