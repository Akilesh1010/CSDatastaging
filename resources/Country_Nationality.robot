*** Settings ***
Documentation       Country Nationality Entity Keywords
...
Country Nationality entity attributes validation
    ${row}=     Read number of rows  CountryNationality
    ${data}=    Read Excel Data of Cell   CountryNationality  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     CountryNationality  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     CountryNationality  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     CountryNationality  ${i}  4
