...
Instrument FundSector entity attributes validation
    ${row}=     Read number of rows  FundSector
    ${data}=    Read Excel Data of Cell   FundSector  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     FundSector  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     FundSector  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     FundSector  ${i}  4
