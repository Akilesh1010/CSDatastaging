...
Resource    ../test_data/person_entity_Address.robot
Resource    ../mapping/personEntity_Address_getIndividual.robot
...
*** Keywords ***
Person entity Address from Figaro JETS Data Source Client Inception Service Endpoint getIndividual service
    ...
    ${GPQL_Response}=      Get Value From Json     ${value}     $.data.person.nodes[0].addresses[0].${GPL_item}
