...
Instrument Instrument entity attributes validation
    ${row}=     Read number of rows  Instrument
    ${data}=    Read Excel Data of Cell   Instrument  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     Instrument  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     Instrument  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     Instrument  ${i}  4
