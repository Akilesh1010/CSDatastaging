...
Instrument Instrument type entity attributes validation
    ${row}=     Read number of rows  Instrument_type
    ${data}=    Read Excel Data of Cell   Instrument_type  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     Instrument_type  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     Instrument_type  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     Instrument_type  ${i}  4
