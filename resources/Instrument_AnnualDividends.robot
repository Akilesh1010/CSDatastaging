...
Instrument AnnualDividends entity attributes validation
    ${row}=     Read number of rows  AnnualDividends
    ${data}=    Read Excel Data of Cell   AnnualDividends  1  1
      FOR   ${i}    IN RANGE   2     ${row}+1
      ${DB Query}=    Read Excel Data of Cell     AnnualDividends  ${i}  2
      ${GQL_Query}=    Read Excel Data of Cell     AnnualDividends  ${i}  3
      ${JSON_PATH}=    Read Excel Data of Cell     AnnualDividends  ${i}  4
