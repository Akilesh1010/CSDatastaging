...
Instrument Dividend entity attributes validation- Fund sedols
    ...
    ${data}=    Read Sedol from excel sheet  Funds  1  1
      ...
      ${Target_Graphql_Output0}   listToStringwithoutcotes    ${Target_Graphql_Output1}
      ${Target_Graphql_Output2}   none_to_blank   ${Target_Graphql_Output0}
